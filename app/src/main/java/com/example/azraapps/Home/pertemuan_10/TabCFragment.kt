...
import com.example.azraapps.databinding.FragmentTabCBinding

class TabCFragment : Fragment() {

    // Menerapkan View Binding pada Fragment
    private var _binding: FragmentTabCBinding? = null
    private val binding get() = _binding!!

    // Kumpulan 50 List Data Dummy Product menggunakan ProductModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Inisialisasi ProductAdapter dengan aksi callback saat salah satu item produk diklik
        ...
        // Menghubungkan Adapter dan LayoutManager ke komponen RecyclerView
        binding.rvProducts.apply {
            // Menggunakan struktur layout Grid 2 Kolom menyamping
            layoutManager = GridLayoutManager(requireContext(), 2)

            // Pasang adapter data ke view recyclerview
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        _binding = null // Mencegah memory leak (kebocoran memori) pada fragment
    }
}