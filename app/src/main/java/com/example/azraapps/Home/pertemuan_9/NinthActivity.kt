package com.example.azraapps.Home.pertemuan_9
...
import com.example.azraapps.databinding.ActivityNinthBinding
...
class NinthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(binding.root) // Hanya gunakan satu setContentView
