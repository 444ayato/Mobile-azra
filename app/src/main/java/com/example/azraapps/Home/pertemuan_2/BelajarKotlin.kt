package com.example.azraapps.Home.pertemuan_2

fun main() {
    println("Hai rekan-rekan...")
    println("Selamat datang di bahjasa pemrograman kotlin")
    ...
    println("========= PERULANGAN =========")
    val kampusKu: Array<String> = arrayOf("Kampus", "Politenik", "Caltex", "Riau")
